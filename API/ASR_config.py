...
def requestid():
    ...
    requestid = requestid.replace("Apr", "")
    requestid = requestid.replace("May", "")
    requestid = requestid.replace("(", "")
    requestid = requestid.replace(")", "")
    requestid = requestid.replace(".", "")
    return requestid
...
extid_list_VLG_CHV_STR = ['5988816004','5988816004','5992883624','5980884835','5980885317']
...
url_VLG_CHV_STR = 'http://10.42.122.25/apiman-gateway/adapters/start-rest-adapter-vlg-chv/1.0-test/v1/finAccounts/'

url_VLG_UDM_STR = 'http://apiman.south.rt.ru/apiman-gateway/adapters/start-plsql-adapter-vlg-udm/1.0-test/v1/finAccounts/'
...
url_STR = 'http://10.42.122.25/apiman-gateway/adapters/start-rest-adapter-vlg-chv/1.0-test/v1/finAccounts/'
url__SIB_NSK_STR = 'http://10.42.122.25/apiman-gateway/adapters/start-rest-adapter-sib-nsk/1.0-test/v1/finAccounts/'
#Курс
url_UG = 'http://apiman.south.rt.ru/apiman-gateway/adapters/kurs-soap-adapter/1.0-dev/v1/finAccounts/'

#ПС

url_PS_SZ = 'http://10.42.122.25/apiman-gateway/adapters/nexign-rest-adapter-sz/1.0-test/v1/finAccounts/'
