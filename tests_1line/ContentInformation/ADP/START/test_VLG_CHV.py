...
def main(extid,param):
    response = requests.get(
        params_config_date.STR_VLG_CHV_TEMP+extid+"/ContentInformation?finAccountNumber="+extid
...
def t2():
    with open('fa_id_VLG_CHV_psi.txt', 'r') as f:
...
def test_date_200(extid,param):
    ...
    with open("data_ContentInformation_Start_VLG_CHV_psi_2.txt", "a") as file:
        # r=response.json()
        # r2 = r[1:0]
